...
{
    bool LoopGeneratorFrame::triangulate(std::vector<shared::Vertex>& vertices, std::vector<shared::Index>& indices, shared::ViewMetadata& statistic, std::vector<MeshFeatureLine>& features_lines, bool export_feature_lines)
    {
        ...
        this->triangulation.process(this->resolution, this->triangle_scale, this->min_loop_length, this->loop_pointer, this->loop_count_pointer, this->loop_segment_pointer, vertices, indices, statistic, features_lines, export_feature_lines);
    ...
    void LoopGenerator::apply(const shared::MeshSettings& settings)
    {
        ...
        this->loop_min_length = 10;// settings.loop.min_loop_length; !!!!!!!!!!!!!!!!!!!!!!!TODO new parameter
    ...
    bool LoopGenerator::submit_frame(MeshGeneratorFrame* frame)
    {
        ...
        loop_frame->min_loop_length = this->loop_min_length;
        
        glClearTexImage(this->vector_buffer, 0, GL_RED_INTEGER, GL_UNSIGNED_BYTE, nullptr);
        glClearTexImage(this->junction_buffer, 0, GL_RED_INTEGER, GL_UNSIGNED_BYTE, nullptr);
    ...
    bool LoopGenerator::create_buffers(const glm::uvec2& resolution)
    {
        ...
        glGenTextures(1, &this->junction_buffer);
        glBindTexture(GL_TEXTURE_2D, this->junction_buffer);
    ...
    bool LoopGenerator::create_shaders()
    {
        ...
        if (!this->vector_shader.load_shader(SHADER_DIRECTORY"experiment_generator_vector_shader.comp", SHADER_TYPE_COMPUTE, defines))
        {
            return false;
        }
        ...
        if (!this->split_shader.load_shader(SHADER_DIRECTORY"experiment_generator_bridge_shader.comp", SHADER_TYPE_COMPUTE, defines))
        {
            return false;
        }
        ...
        if (!this->base_shader.load_shader(SHADER_DIRECTORY"experiment_generator_base_shader.comp", SHADER_TYPE_COMPUTE, defines))
        {
            return false;
        }
        ...
        if (!this->combine_shader.load_shader(SHADER_DIRECTORY"experiment_generator_combine_shader.comp", SHADER_TYPE_COMPUTE, defines))
        {
            return false;
        }
        ...
        if (!this->distribute_shader.load_shader(SHADER_DIRECTORY"experiment_generator_distribute_shader.comp", SHADER_TYPE_COMPUTE, defines))
        {
            return false;
        }
        ...
        if (!this->discard_shader.load_shader(SHADER_DIRECTORY"experiment_generator_discard_shader.comp", SHADER_TYPE_COMPUTE, defines))
        {
            return false;
        }
        ...
        if (!this->write_shader.load_shader(SHADER_DIRECTORY"experiment_generator_write_shader.comp", SHADER_TYPE_COMPUTE, defines))
        {
            return false;
        }
    ...
    void LoopGenerator::destroy_buffers()
    {
        ...
        //glDeleteTextures(1, &this->filter_buffer);
        glDeleteTextures(1, &this->vector_buffer);
        glDeleteTextures(1, &this->junction_buffer);

        //this->filter_buffer = 0;
        this->vector_buffer = 0;
        this->junction_buffer = 0;
    ...
    /*void LoopGenerator::perform_filter_pass(LoopGeneratorFrame* loop_frame)
    {
        std::string pass_label = "experiment_generator_vector_pass";
        ...
        glBindImageTexture(0, this->filter_buffer, 0, GL_FALSE, 0, GL_WRITE_ONLY, GL_R8UI);

        this->filter_shader.use_shader();
        this->filter_shader["depth_max"] = this->depth_max;
        this->filter_shader["depth_base_threshold"] = this->depth_base_threshold;
        this->filter_shader["depth_slope_threshold"] = this->depth_slope_threshold;
        this->filter_shader["use_normals"] = this->use_normals;
        this->filter_shader["use_object_ids"] = this->use_object_ids;
        ...
        this->filter_shader.use_default();
    ...
    void LoopGenerator::perform_vector_pass(LoopGeneratorFrame* loop_frame)
    {
        ...
        glBindImageTexture(1, this->junction_buffer, 0, GL_FALSE, 0, GL_WRITE_ONLY, GL_R8UI);
    ...
    void LoopGenerator::perform_base_pass(LoopGeneratorFrame* loop_frame)
    {
        ...
        this->base_shader["loop_min_length"] = this->loop_min_length;
    ...
    void LoopGenerator::perform_combine_pass(LoopGeneratorFrame* loop_frame)
    {
        ...
        this->combine_shader["loop_min_length"] = this->loop_min_length;
