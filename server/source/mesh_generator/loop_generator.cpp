...
bool LoopGenerator::create_shaders()
{
    ...
    if (!this->vector_shader.load_shader(SHADER_DIRECTORY"loop_generator_vector_shader.comp", SHADER_TYPE_COMPUTE, defines))
    {
        return false;
    }
    ...
    if (!this->base_shader.load_shader(SHADER_DIRECTORY"loop_generator_base_shader.comp", SHADER_TYPE_COMPUTE, defines))
    {
        return false;
    }
    ...
    if (!this->combine_shader.load_shader(SHADER_DIRECTORY"loop_generator_combine_shader.comp", SHADER_TYPE_COMPUTE, defines))
    {
        return false;
    }
    ...
    if (!this->distribute_shader.load_shader(SHADER_DIRECTORY"loop_generator_distribute_shader.comp", SHADER_TYPE_COMPUTE, defines))
    {
        return false;
    }
    ...
    if (!this->write_shader.load_shader(SHADER_DIRECTORY"loop_generator_write_shader.comp", SHADER_TYPE_COMPUTE, defines))
    {
        return false;
    }
...
void LoopGenerator::perform_write_pass(LoopGeneratorFrame* loop_frame)
{
    ...
    this->write_shader["depth_base_threshold"] = this->depth_base_threshold;
